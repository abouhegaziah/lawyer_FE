                  ...
                  <p>
                    {localStorage.getItem("lang") === "english" ? (
                      ...
                      <>
                        ...
                        القنصلية المصرية في الإمارات العربية المتحدة.
                      </>
                    )}
                  </p>
                  <p>
                    {localStorage.getItem("lang") === "english" ? (
                      ...
                      <>
                        ...
                        يضعة أشهر وبعد تجربة شخصية رائعة ، وجد المستشار أحمد
                        الشاعر السلام الداخلي مرة أخرى عندما واجه المغفرة من أحد
                        أفراد الأسرة ، مما دفعه إلى إعادة تنظيم أفكاره والتوصل
                        إلى النسخة النهائية من "عفو ملكي" حيث يمكنه الاستماع
